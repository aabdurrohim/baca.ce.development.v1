<footer class="footer" style="background-color: #001349;">
    <div class="p-5 row">
        <div class="position-relative col-sm-4">
            <img src="{{ asset('assets/images/LOGO-UNDIP-1.png') }}"class="top-50 position-absolute start-50 translate-middle"
